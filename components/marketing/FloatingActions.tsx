  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 flex flex-col items-end gap-3">
      ...
      <a
        ...
        aria-label="Call now"
        className="flex h-14 w-14 items-center justify-center rounded-full bg-navy-900 p-3.5 text-white shadow-lg transition-transform hover:scale-105"
      >
        <Phone size={22} />
      </a>
      ...
      <button
        ...
        className="flex h-14 w-14 items-center justify-center rounded-full bg-gold-500 p-3.5 text-navy-950 shadow-lg transition-transform hover:scale-105"
      >
